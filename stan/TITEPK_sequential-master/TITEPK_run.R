...
model_titepk <- stan_model("stan/TITEPK_sequential-master/src/tite_pk_run.stan", "TITE-PK One parameter model")
...
## Load the dataset
# For our model
dat_RAD_daily <- read.csv("stan/TITEPK_sequential-master/data/dat_RAD_daily")
